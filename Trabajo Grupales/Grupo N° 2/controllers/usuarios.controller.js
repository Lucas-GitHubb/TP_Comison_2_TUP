...
export const crearUsuario = async (req, res) => { 
  try {
    ...
    const query = "INSERT INTO usuarios (correoUsuario, contraseñaUsuario) VALUES (?, ?)";
...
export const modificarUsuario = async (req, res) => {
    try {
        ...
        const query = "UPDATE usuarios SET correoUsuario = ?, contraseñaUsuario = ? WHERE idUsuario = ?";
...
export const obtenerUsuarios = async (req, res) => {
    try {
        const query = "SELECT idUsuario, correoUsuario, contraseñaUsuario FROM usuarios";
...
export const obtenerUsuarioPorId = async (req, res) => {
    try {
        const { idUsuario } = req.params;
        const query = "SELECT idUsuario, correoUsuario, contraseñaUsuario FROM usuarios WHERE idUsuario = ?";
